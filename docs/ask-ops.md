...
11. Speak a question into Mic. The input fills, Ask runs, and the latest reply shows **Speaking…** (cyan pulse) when the Speak cap allows. A typed Ask returns text only (no auto-Speak).
